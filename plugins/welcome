...
local function description_rules(msg, nama)
   ...
   if data[tostring(msg.to.id)] then
      ...
      local sambutan = "salam "..nama.."\ndayous , khosh umadi be goroohe'"..string.gsub(msg.to.print_name, "_", " ").."'\nyadet bashe ziad kos sher nagi to in gorooh :D\n"
